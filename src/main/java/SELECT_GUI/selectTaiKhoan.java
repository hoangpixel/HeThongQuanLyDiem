 ...
 * @author mhoang
 */
public class selectTaiKhoan extends javax.swing.JDialog {
    public taiKhoanETT taiKhoan = new taiKhoanETT();
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(selectTaiKhoan.class.getName());

    /**
     * Creates new form selectThiSinh
     */
    public selectTaiKhoan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void loadPage(int page)
{
    ...
    {
        taiKhoanETT ct = bus.ds.get(i);
        Vector row = new Vector();
        row.add(ct.getIdTaiKhoan());
        row.add(ct.getTenDangNhap());
        row.add(ct.getHoTen());
        row.add(ct.getTrangThai());
        model.addRow(row);
    }
    ...
    public void updatePaginationUI()
{
    ...
    void header()
    {
        ...
        headerVec.add("ID");
        headerVec.add("Tên đăng nhập");
        headerVec.add("Họ tên");
        headerVec.add("Trạng thái");
        ...
        // ===== HEADER =====
        JTableHeader header = tbTaiKhoan.getTableHeader(); // ✅ FIX Ở ĐÂY
        ...
        // ===== TABLE =====
        tbTaiKhoan.setFont(mainFont);
        tbTaiKhoan.setRowHeight(32);
        tbTaiKhoan.setSelectionBackground(new Color(52, 152, 219));
        tbTaiKhoan.setSelectionForeground(Color.WHITE);

        tbTaiKhoan.setShowGrid(false);
        tbTaiKhoan.setIntercellSpacing(new Dimension(0, 0));

        // ===== RENDER =====
        tbTaiKhoan.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            @Override
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tìm kiếm tài khoản", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14))); // NOI18N
    ...
    private void tbTaiKhoanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbTaiKhoanMouseClicked
        ...
        if(evt.getClickCount() == 2)
        {
            ...
            if(i != -1)
            {
                int modelIndex = tbTaiKhoan.convertRowIndexToModel(i);
//                thiSinh = bus.ds.get(modelIndex);
int realIndex = (currentPage - 1) * rowsPerPage + modelIndex;
taiKhoan = bus.ds.get(realIndex);
                xacNhan = true;
                dispose();
            }
        }
    ...
    public taiKhoanETT getTaiKhoan()
    {
        return taiKhoan;
    }
