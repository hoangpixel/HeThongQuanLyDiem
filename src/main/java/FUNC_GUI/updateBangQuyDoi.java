...
public class updateBangQuyDoi extends javax.swing.JDialog {
        ...
        private void fillForm() {
                ...
                String toHop = quyDoi.getToHop();
                String mon = quyDoi.getMon();
                if (PT_VSAT.equals(pt) && isBlank(toHop)) {
                        toHop = KHONG;
                }
                if (PT_DGNL.equals(pt) && isBlank(mon)) {
                        mon = KHONG;
                }

                txtToHop.setText(nvl(toHop));
                txtMon.setText(nvl(mon));
        ...
        private void onSave() {
                        ...
                        if (bangQuyDoiBUS.ds != null) {
                                for (bangQuyDoiETT item : bangQuyDoiBUS.ds) {
                                        if (item != null && item.getMaQuyDoi() != null
                                                        && item.getMaQuyDoi().equalsIgnoreCase(newMa)) {
                ...
                String phuongThuc = ptSel != null ? ptSel.toString().trim() : null;
                quyDoi.setPhuongThuc(phuongThuc);
