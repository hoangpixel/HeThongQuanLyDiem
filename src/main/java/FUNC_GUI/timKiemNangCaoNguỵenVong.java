 ...
 * @author mhoang
 */
public class timKiemNangCaoNguỵenVong extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(timKiemNangCaoNguỵenVong.class.getName());
    private boolean xacNhan = false;
    private ArrayList<nguyenVongXetTuyenETT> dskq = new ArrayList<>();
    private String cccd, maNganh,toHop;
    
    /**
     * Creates new form timKiemNangCao
     */
    public timKiemNangCaoNguỵenVong(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnLocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLocActionPerformed
        ...
        int thuTu = (Integer) txtThuTu.getValue();
        String phuongThuc = cboPhuongThuc.getSelectedItem().toString();
        String ketQua = cboKetQua.getSelectedItem().toString();

        // Gọi hàm BUS
        nguyenVongXetTuyenBUS bus = new nguyenVongXetTuyenBUS();
        dskq = bus.timKiemNangCao(cccd, maNganh, toHop, thuTu, phuongThuc, ketQua);
    ...
    public ArrayList<Entity.nguyenVongXetTuyenETT> getDanhSachLoc() 
    {
        return dskq;
    }
