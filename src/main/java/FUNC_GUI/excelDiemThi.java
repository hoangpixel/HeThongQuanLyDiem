/*
 * Excel import/export form for exam scores (Điểm thi)
 */
package FUNC_GUI;
 ...
 * @author Admin
 */
public class excelDiemThi extends javax.swing.JDialog {
    
    public boolean xacNhanImport = false, xacNhanExport = false;
    
    public excelDiemThi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        groupBoxExcel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thực hiện Import/Export excel Điểm Thi", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14)));
