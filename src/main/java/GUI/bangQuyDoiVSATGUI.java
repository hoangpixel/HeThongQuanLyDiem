...
// Giả sử cột Phương thức nằm ở vị trí số 3, Tổ hợp số 4 (Nhớ đếm index từ 0 nha)
    ...
    private void hienThiDialogThem() {
        ...
        insertBangQuyDoi dialog = new insertBangQuyDoi(topFrame, true);
    ...
    private void hienThiDialogSua() {
        ...
        JFrame topFrame = (JFrame) SwingUtilities.getWindowAncestor(this);
        updateBangQuyDoi dialog = new updateBangQuyDoi(topFrame, true, cu);
        dialog.setVisible(true);
    ...
    private void hienThiDialogXoa() {
        ...
        JFrame topFrame = (JFrame) SwingUtilities.getWindowAncestor(this);
        deleteBangQuyDoi dialog = new deleteBangQuyDoi(topFrame, true);
        dialog.setVisible(true);
